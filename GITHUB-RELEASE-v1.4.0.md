...
- 🚂 **Hype Train Ende** wird mit Details angezeigt:
  - Level erreicht
  - ⭐ Anzahl Subs beigetragen
  - 💎 Anzahl Bits beigetragen
...
- 📍 **Kompakte Anzeige** im Footer (rechts unten) statt störendem Banner
...
- 🎯 **Kein Emoji-Regen** für Hype Train (nur Zug-Animation)
...
- 🔕 **Aus-Modus** - Keine visuellen Effekte
- 💾 **Einstellung wird gespeichert** und beim nächsten Start wiederhergestellt
- 🎯 **Ein Button zum Durchschalten** in Alerts & Benachrichtigungen
- 📝 **Info-Text** zeigt aktuellen Modus an
...
- 🚀 Alerts & Benachrichtigungen zeigt Raids + Sub-Bomben (5+)
